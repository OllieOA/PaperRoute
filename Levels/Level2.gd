...
var next_level = "res://Levels/SadScene2.tscn"
...
# Level completion
export var newspapers_for_level = 8
export var deliveries_for_level = 3
...
func _ready() -> void:
	...
	goal3.connect("paper_delivered", self, "_goal_completed")
	music.play()
